...
func (*GetDumpParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcdump, []int{0} }
...
func (c *dumpClient) GetDump(ctx context.Context, in *GetDumpParam, opts ...grpc.CallOption) (Dump_GetDumpClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Dump_serviceDesc.Streams[0], c.cc, "/rpcdump.Dump/GetDump", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("rpcdump.proto", fileDescriptorRpcdump) }
func init() { golang_proto.RegisterFile("rpcdump.proto", fileDescriptorRpcdump) }

var fileDescriptorRpcdump = []byte{
