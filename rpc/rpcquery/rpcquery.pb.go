...
func (*GetStorageParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{2} }
...
func (*StorageValue) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{3} }
...
func (*ListAccountsParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{4} }
...
func (*GetNameParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{5} }
...
func (*ListNamesParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{6} }
...
func (*GetValidatorSetParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{7} }
...
func (*GetValidatorSetHistoryParam) Descriptor() ([]byte, []int) {
	return fileDescriptorRpcquery, []int{8}
}
...
func (*ValidatorSetHistory) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{9} }
...
func (*ValidatorSet) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{10} }
...
func (*GetProposalParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{11} }
...
func (*ListProposalsParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{12} }
...
func (*ProposalResult) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{13} }
...
func (*GetStatsParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{14} }
...
func (*Stats) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{15} }
...
func (*GetBlockParam) Descriptor() ([]byte, []int) { return fileDescriptorRpcquery, []int{16} }
...
func (c *queryClient) GetStorage(ctx context.Context, in *GetStorageParam, opts ...grpc.CallOption) (*StorageValue, error) {
	...
	err := grpc.Invoke(ctx, "/rpcquery.Query/GetStorage", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetValidatorSetHistory(ctx context.Context, in *GetValidatorSetHistoryParam, opts ...grpc.CallOption) (*ValidatorSetHistory, error) {
	...
	err := grpc.Invoke(ctx, "/rpcquery.Query/GetValidatorSetHistory", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetProposal(ctx context.Context, in *GetProposalParam, opts ...grpc.CallOption) (*payload.Ballot, error) {
	...
	err := grpc.Invoke(ctx, "/rpcquery.Query/GetProposal", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListProposals(ctx context.Context, in *ListProposalsParam, opts ...grpc.CallOption) (Query_ListProposalsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Query_serviceDesc.Streams[2], c.cc, "/rpcquery.Query/ListProposals", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *queryClient) GetStats(ctx context.Context, in *GetStatsParam, opts ...grpc.CallOption) (*Stats, error) {
	out := new(Stats)
	err := grpc.Invoke(ctx, "/rpcquery.Query/GetStats", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetBlockHeader(ctx context.Context, in *GetBlockParam, opts ...grpc.CallOption) (*types.Header, error) {
	...
	err := grpc.Invoke(ctx, "/rpcquery.Query/GetBlockHeader", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
