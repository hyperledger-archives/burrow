...
func (Bound_BoundType) EnumDescriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{6, 0} }
...
func (*TxRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{1} }
...
func (*EventsResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{3} }
...
func (*GetTxsRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{4} }
...
func (*GetTxsResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{5} }
...
func (*Bound) Descriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{6} }
...
func (*BlockRange) Descriptor() ([]byte, []int) { return fileDescriptorRpcevents, []int{7} }
...
func (c *executionEventsClient) Stream(ctx context.Context, in *BlocksRequest, opts ...grpc.CallOption) (ExecutionEvents_StreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ExecutionEvents_serviceDesc.Streams[0], c.cc, "/rpcevents.ExecutionEvents/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *executionEventsClient) Tx(ctx context.Context, in *TxRequest, opts ...grpc.CallOption) (*exec.TxExecution, error) {
	...
	err := grpc.Invoke(ctx, "/rpcevents.ExecutionEvents/Tx", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executionEventsClient) Events(ctx context.Context, in *BlocksRequest, opts ...grpc.CallOption) (ExecutionEvents_EventsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ExecutionEvents_serviceDesc.Streams[1], c.cc, "/rpcevents.ExecutionEvents/Events", opts...)
	if err != nil {
		return nil, err
	}
