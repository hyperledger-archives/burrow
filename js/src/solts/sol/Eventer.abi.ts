...
import { Address, CallTx, ContractCodec, Event, EventStream, listenerFor, Signal } from '../../index';
interface Provider {
        ...
        Init(
          ...
          return client.listen(
            ...
            (err?: Error, event?: Event) => {
              ...
              return callback(
                undefined,
                decode(client, event?.getLog()?.getData_asU8(), event?.getLog()?.getTopicsList_asU8()).Init(),
              );
            },
            start,
            end,
        ...
        MonoRampage(
          ...
          return client.listen(
            ...
            (err?: Error, event?: Event) => {
              ...
              return callback(
                undefined,
                decode(client, event?.getLog()?.getData_asU8(), event?.getLog()?.getTopicsList_asU8()).MonoRampage(),
              );
            },
            start,
            end,
