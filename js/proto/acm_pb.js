...
goog.exportSymbol('proto.acm.EVMCode', null, global);
/**
 ...
 * @constructor
 */
proto.acm.EVMCode = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.acm.EVMCode, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.acm.EVMCode.displayName = 'proto.acm.EVMCode';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.acm.Account.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    evmcode: (f = msg.getEvmcode()) && proto.acm.EVMCode.toObject(includeInstance, f),
...
proto.acm.Account.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 12:
      var value = new proto.acm.EVMCode;
      reader.readMessage(value,proto.acm.EVMCode.deserializeBinaryFromReader);
...
proto.acm.Account.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getEvmcode();
  if (f != null) {
    writer.writeMessage(
      12,
      f,
      proto.acm.EVMCode.serializeBinaryToWriter
    );
  }
...
/**
 * optional EVMCode EVMCode = 12;
 * @return {?proto.acm.EVMCode}
 */
proto.acm.Account.prototype.getEvmcode = function() {
  return /** @type{?proto.acm.EVMCode} */ (
    jspb.Message.getWrapperField(this, proto.acm.EVMCode, 12));
};


/**
 * @param {?proto.acm.EVMCode|undefined} value
 * @return {!proto.acm.Account} returns this
*/
 ...
 * @return {!proto.acm.Account} returns this
 */
proto.acm.Account.prototype.clearEvmcode = function() {
  return this.setEvmcode(undefined);
};
 ...
 * @return {boolean}
 */
proto.acm.Account.prototype.hasEvmcode = function() {
 ...
 * @return {!Object}
 */
proto.acm.EVMCode.prototype.toObject = function(opt_includeInstance) {
  return proto.acm.EVMCode.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.acm.EVMCode} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.acm.EVMCode.toObject = function(includeInstance, msg) {
  var f, obj = {
    bytecode: msg.getBytecode_asB64(),
    opcodebitset: msg.getOpcodebitset_asB64()
  };
 ...
 * @return {!proto.acm.EVMCode}
 */
proto.acm.EVMCode.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.acm.EVMCode;
  return proto.acm.EVMCode.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.acm.EVMCode} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.acm.EVMCode}
 */
proto.acm.EVMCode.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.acm.EVMCode.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.acm.EVMCode.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.acm.EVMCode} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.acm.EVMCode.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  f = message.getOpcodebitset_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      2,
      f
 ...
 * @return {!(string|Uint8Array)}
 */
proto.acm.EVMCode.prototype.getBytecode = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.acm.EVMCode.prototype.getBytecode_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getBytecode()));
};
 ...
 * @return {!Uint8Array}
 */
proto.acm.EVMCode.prototype.getBytecode_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getBytecode()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.acm.EVMCode} returns this
 */
proto.acm.EVMCode.prototype.setBytecode = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};


/**
 * optional bytes OpcodeBitset = 2;
 * @return {!(string|Uint8Array)}
 */
proto.acm.EVMCode.prototype.getOpcodebitset = function() {
...
/**
 * optional bytes OpcodeBitset = 2;
 * This is a type-conversion wrapper around `getOpcodebitset()`
 * @return {string}
 */
proto.acm.EVMCode.prototype.getOpcodebitset_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getOpcodebitset()));
};
 ...
 * @return {!Uint8Array}
 */
proto.acm.EVMCode.prototype.getOpcodebitset_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getOpcodebitset()));
};
 ...
 * @return {!proto.acm.EVMCode} returns this
 */
proto.acm.EVMCode.prototype.setOpcodebitset = function(value) {
