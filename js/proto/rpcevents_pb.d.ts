...
export class Bound extends jspb.Message {
  getType(): Bound.BoundTypeMap[keyof Bound.BoundTypeMap];
  setType(value: Bound.BoundTypeMap[keyof Bound.BoundTypeMap]): void;
...
export namespace Bound {
  export type AsObject = {
    type: Bound.BoundTypeMap[keyof Bound.BoundTypeMap],
    index: number,
  }

  export interface BoundTypeMap {
    ABSOLUTE: 0;
    RELATIVE: 1;
    FIRST: 2;
    LATEST: 3;
  ...
  export const BoundType: BoundTypeMap;
}
