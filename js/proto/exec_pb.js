...
goog.exportSymbol('proto.exec.PrintEvent', null, global);
 ...
 * @constructor
 */
proto.exec.PrintEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.exec.PrintEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.exec.PrintEvent.displayName = 'proto.exec.PrintEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!proto.exec.EndTx} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.exec.TxHeader} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.exec.TxExecutionKey} returns this
 */
...
/**
 * @param {?proto.exec.TxHeader|undefined} value
 * @return {!proto.exec.TxExecution} returns this
*/
...
/**
 * @param {string} value
 * @return {!proto.exec.Origin} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.exec.Header} returns this
 */
...
proto.exec.Event.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    print: (f = msg.getPrint()) && proto.exec.PrintEvent.toObject(includeInstance, f)
  };
...
proto.exec.Event.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.exec.PrintEvent;
      reader.readMessage(value,proto.exec.PrintEvent.deserializeBinaryFromReader);
      msg.setPrint(value);
      break;
    default:
      reader.skipField();
...
proto.exec.Event.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.exec.PrintEvent.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!proto.exec.Event} returns this
*/
...
proto.exec.Event.prototype.clearGovernaccount = function() {
  return this.setGovernaccount(undefined);
};
...
/**
 * optional PrintEvent Print = 7;
 * @return {?proto.exec.PrintEvent}
 */
proto.exec.Event.prototype.getPrint = function() {
  return /** @type{?proto.exec.PrintEvent} */ (
    jspb.Message.getWrapperField(this, proto.exec.PrintEvent, 7));
};


/**
 * @param {?proto.exec.PrintEvent|undefined} value
 * @return {!proto.exec.Event} returns this
*/
proto.exec.Event.prototype.setPrint = function(value) {
  return jspb.Message.setWrapperField(this, 7, value);
};
 ...
 * @return {!proto.exec.Event} returns this
 */
proto.exec.Event.prototype.clearPrint = function() {
 ...
 * @return {boolean}
 */
proto.exec.Event.prototype.hasPrint = function() {
  return jspb.Message.getField(this, 7) != null;
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.exec.Result} returns this
 */
...
proto.exec.Result.prototype.clearNameentry = function() {
  return this.setNameentry(undefined);
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.exec.LogEvent} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.exec.CallEvent} returns this
 */
 ...
 * @return {!Object}
 */
proto.exec.PrintEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.exec.PrintEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.exec.PrintEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.exec.PrintEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    address: msg.getAddress_asB64(),
    data: msg.getData_asB64()
  };
 ...
 * @return {!proto.exec.PrintEvent}
 */
proto.exec.PrintEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.exec.PrintEvent;
  return proto.exec.PrintEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.exec.PrintEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.exec.PrintEvent}
 */
proto.exec.PrintEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.exec.PrintEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.exec.PrintEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.exec.PrintEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.exec.PrintEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAddress_asU8();
  if (f.length > 0) {
    writer.writeBytes(
 ...
 * @return {!(string|Uint8Array)}
 */
proto.exec.PrintEvent.prototype.getAddress = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.exec.PrintEvent.prototype.getAddress_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getAddress()));
};
 ...
 * @return {!Uint8Array}
 */
proto.exec.PrintEvent.prototype.getAddress_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getAddress()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.exec.PrintEvent} returns this
 */
proto.exec.PrintEvent.prototype.setAddress = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.exec.PrintEvent.prototype.getData = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.exec.PrintEvent.prototype.getData_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getData()));
};
 ...
 * @return {!Uint8Array}
 */
proto.exec.PrintEvent.prototype.getData_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getData()));
};
 ...
 * @return {!proto.exec.PrintEvent} returns this
 */
proto.exec.PrintEvent.prototype.setData = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!proto.exec.GovernAccountEvent} returns this
*/
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.exec.InputEvent} returns this
 */
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.exec.OutputEvent} returns this
 */
