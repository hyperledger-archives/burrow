...
func TestStateToFromVMAccount(t *testing.T) {
	privAccount := account.GenPrivAccountFromSecret("TestStateToFromVMAccount")
	acmAcc1 := &account.Account{
		Address:     privAccount.PubKey.Address(),
		PubKey:      privAccount.PubKey,
		Sequence:    29,
		Balance:     int64(120034),
		Permissions: types.DefaultAccountPermissions,
	}
