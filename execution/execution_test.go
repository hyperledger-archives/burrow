...
func init() {
	...
	for i := 0; i < 3; i++ {
		...
		doug[i].MutablePermissions().Base.Set(ptypes.Call, true)
		doug[i].MutablePermissions().Base.Set(ptypes.CreateContract, true)
		doug[i].MutablePermissions().Base.Set(ptypes.CreateAccount, true)
	}
}
