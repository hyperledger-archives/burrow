...
/*
	Package bcm is a generated protocol buffer package.
...
type SyncInfo struct {
	...
	LatestBlockDuration time.Duration `protobuf:"bytes,6,opt,name=LatestBlockDuration,stdduration" json:"LatestBlockDuration"`
}

func (m *SyncInfo) Reset()                    { *m = SyncInfo{} }
func (m *SyncInfo) String() string            { return proto.CompactTextString(m) }
func (*SyncInfo) ProtoMessage()               {}
func (*SyncInfo) Descriptor() ([]byte, []int) { return fileDescriptorBcm, []int{0} }
...
func (m *SyncInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x22
	i++
	i = encodeVarintBcm(dAtA, i, uint64(types.SizeOfStdTime(m.LatestBlockTime)))
	n3, err := types.StdTimeMarshalTo(m.LatestBlockTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	dAtA[i] = 0x2a
	i++
	i = encodeVarintBcm(dAtA, i, uint64(types.SizeOfStdTime(m.LatestBlockSeenTime)))
	n4, err := types.StdTimeMarshalTo(m.LatestBlockSeenTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
	dAtA[i] = 0x32
	i++
	i = encodeVarintBcm(dAtA, i, uint64(types.SizeOfStdDuration(m.LatestBlockDuration)))
	n5, err := types.StdDurationMarshalTo(m.LatestBlockDuration, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n5
...
func (m *SyncInfo) Size() (n int) {
	...
	n += 1 + l + sovBcm(uint64(l))
	l = types.SizeOfStdDuration(m.LatestBlockDuration)
	n += 1 + l + sovBcm(uint64(l))
	return n
}
...
func (m *SyncInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := types.StdDurationUnmarshal(&m.LatestBlockDuration, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("bcm.proto", fileDescriptorBcm) }
func init() { golang_proto.RegisterFile("bcm.proto", fileDescriptorBcm) }

var fileDescriptorBcm = []byte{
