...
func NewNoopInfoTraceLogger() InfoTraceLogger {
	return &infoTraceLogger{
		mcl: NewMultipleChannelLogger(map[string]kitlog.Logger{
			InfoChannelName:  kitlog.NewNopLogger(),
			TraceChannelName: kitlog.NewNopLogger(),
		}),
	}
}
