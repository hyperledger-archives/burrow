...
func GetConfig(rootDir string) cfg.Config {
	...
	mapConfig.SetDefault("erisdb_genesis_file", rootDir+"/erisdb_genesis.json")
	mapConfig.SetDefault("tendermint_genesis_file", rootDir+"/tendermint_genesis.json")
	mapConfig.SetDefault("genesis_file", rootDir+"/tendermint_genesis.json") // copy tendermint_genesis_file
