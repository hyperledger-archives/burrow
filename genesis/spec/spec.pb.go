...
package spec // import "github.com/hyperledger/burrow/genesis/spec"
...
func (dst *TemplateAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TemplateAccount.Merge(dst, src)
}
